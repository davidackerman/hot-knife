...
datasetnames=mito,nucleus

path=/groups/cosem/cosem/ackermand/paperResultsWithFullPaths/collected/Jurkat.n5
...
--outputN5Path '/groups/cosem/cosem/ackermand/paperResultsWithFullPaths/collected/Jurkat.n5' \
